...
namespace GroupWorkerTwo.Main
{
    ...
    public class App : IExternalApplication
    {
        ...
        private void ControlledApplicationOnApplicationInitialized(object sender, ApplicationInitializedEventArgs e)
        {
            ...
            var appDataProperties = _serviceLocator.Get<IApplicationDataProperties>();
        ...
        {
            _serviceLocator = new StandardKernel();
            _serviceLocator.Load(new DependencyInjectionManager());
        }
    }
}
